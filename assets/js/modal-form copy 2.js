	...
	anchor.addEventListener("click", function () {
        ...
        <div class="video-container" style="position: relative; width: 100%;">
          ...
          <button id="video-play" class="video-control"
            ...
            <img src="../assets/img/iconos/audio/play.svg" alt="Play" style="width:48px; height:48px; border-radius: 0;">
          </button>
          <button id="video-stop" class="video-control"
                  style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);
                         background: none; border: none; cursor: pointer; display: none; border-radius: 0;">
            <img src="../assets/img/iconos/audio/stop.svg" alt="Stop" style="width:48px; height:48px; border-radius: 0;">
          </button>
        </div>
      `;
...
document.addEventListener("DOMContentLoaded", function () {
	...
	previewContainers.forEach(function (container) {
		...
		iconImg.src = "../assets/img/iconos/audio/unmute.svg";
		iconImg.alt = "Unmute";
		...
		muteBtn.addEventListener("click", function (e) {
			...
			if (video.muted) {
				...
				iconImg.src = "../assets/img/iconos/audio/mute.svg";
				iconImg.alt = "Mute";
			}
		});
	});
