...
<html lang="es">
    ...
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="firma/css/config.css" />
        <link type="text/css" rel="stylesheet" href="firma/css/libs.css" />
        <link type="text/css" rel="stylesheet" href="firma/css/style.css" />
        <link type="text/css" rel="stylesheet" href="firma/css/responsive.css" />
        <link type="text/css" rel="stylesheet" href="firma/css/base.css" />
        <link type="text/css" rel="stylesheet" href="firma/css/content.css" />
        <link type="text/css" rel="stylesheet" href="firma/css/firma.css" />
        <link rel="icon" href="firma/img/favicon.png" sizes="32x32" />
    ...
    <body id="home">
            ...
            <div class="cs-header-inner">
                <div class="cs-header-lp">
                    <a href="http://comustock.personal.com.ar/" target="_blank" class="cs-logo">
                        <img src="firma/img/logo-comustock.svg" alt="ComuStock" width="140" height="27" />
                    </a>
                </div>
                        ...
                        <ul class="main-menu" data-stagger-appear="fade-down" data-stagger-delay="75">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="http://comustock.personal.com.ar/recursos/#iconos"
                                            target="_blank">Íconos</a></li>
                                    <li><a href="http://comustock.personal.com.ar/recursos/#elementos"
                                ...
                                <form name="personal-info" autocomplete="on" id="form">
                                    <fieldset>
                                        ...
                                        <select name="dominio">
                                            ...
                                            <option value="Dominio Negocio Conectividad">Dominio Negocio
                                                Conectividad
                                            </option>
                                            <option value="Dominio Negocio Digital Growth">Dominio Negocio Digital
                                                Growth
                                            </option>
                                            <option value="Dominio Negocio Entretenimiento">Dominio Negocio
                                                Entretenimiento
                                            </option>
                                            <option value="Dominio Negocio Fintech">Dominio Negocio Fintech</option>
                                            <option value="Dominio Organizacional">Dominio Organizacional</option>
                                            <option value="Gestion de Socios">Gestion de Socios</option>
        ...
        <script src="firma/js/lib/jquery.min.js"></script>
        <script src="firma/js/lib/libs.js"></script>
        <script src="firma/js/contact_form.js"></script>
        <script src="firma/js/st-core.js"></script>
        <script src="firma/js/classes.js"></script>
        <script src="firma/js/main.js"></script>
        <script src="firma/js/firma.js"></script>
    </body>
